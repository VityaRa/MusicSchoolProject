...
<asp:Content ID="ScheduleContent" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper">
        ...
        <asp:DropDownList runat="server" DataSourceID="GetAllStartTimes" ID="StartTimeDropDown" DataTextField="start_time" DataValueField="start_time" AutoPostBack="True" OnSelectedIndexChanged="StartTimeDropDown_SelectedIndexChanged"></asp:DropDownList>
        ...
        ((week_day.weekdayID = @__selected_week_day) OR (@__selected_week_day = 0)) AND ((teacher.teacherID = @__selected_teacher_id) OR (@__selected_teacher_id = 0) AND (group_class.start_time = @__selected_start_time OR group_class.start_time IS NOT NULL))"
            ...
            <SelectParameters>
                ...
                <asp:Parameter Name="__selected_start_time" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
