/// <summary>
/// Summary description for SessionConsts
/// </summary>
public class SessionConsts
{
    ...
    public static string SelectedApplicationStatusId = "__selected_application_status_id";
    public static string SelectedApplicationId = "__selected_application_id";
}